...
class Student:
    def __init__(self, student_data):
        ...
        if (len(split_line) != 8) or not(is_int(split_line[2])) or not(is_int(split_line[3])) or not(is_int(split_line[4])) or (not(is_int(split_line[5])) and not(is_float(split_line[5]))):
            self.error = True
        else:
            self.error = False
    ...
    def __str__(self):
        return self.lastName + "," + self.firstName + "," + str(self.studentGrade) + "," + str(self.classroomNum) + "," + str(self.busRouteNum) + "," + str(self.studentGPA) + "," + self.teacherLastName + "," + self.teacherFirstName
    ...
    for student in students:
        if command_line[1] == student.lastName:
            if bus_route:
                ...
                print(student.lastName + "," + student.firstName + "," + str(student.studentGrade) + "," + str(student.classroomNum) + "," + str(student.teacherLastName) + "," + str(student.teacherFirstName))  
    return
...
def find_grade(command_line, students):
    ...
    if low:
        ...
        if lowest_grade != 5:
            print(lowest_grade_student.lastName + "," + lowest_grade_student.firstName + "," + str(lowest_grade_student.studentGPA) + "," + lowest_grade_student.teacherLastName + "," + lowest_grade_student.teacherFirstName + "," + str(lowest_grade_student.busRouteNum))
    else:
       highest_grade = 0
       ...
       if highest_grade != 0:
           print(highest_grade_student.lastName + "," + highest_grade_student.firstName + "," + str(highest_grade_student.studentGPA) + "," + str(highest_grade_student.teacherLastName) + "," + str(highest_grade_student.teacherFirstName) + "," + str(highest_grade_student.busRouteNum))
    return
